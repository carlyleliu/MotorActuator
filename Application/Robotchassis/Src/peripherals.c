...
void SystemClockConfig(void)
{
    ...
    PeriphClkInit.PeriphClockSelection = RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2
                                         | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_ADC12 | RCC_PERIPHCLK_FDCAN;
 ...
 * @retval None
 */
static void Usart1Init(uint32_t baudRate)
{
 ...
 * @retval None
 */
static void Usart2Init(uint32_t baudRate)
{
 ...
 * @retval None
 */
EXPORT void PeripheralsInit(void)
{
    GpioInit();
