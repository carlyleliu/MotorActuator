#ifndef APPLICATION_SYSLOG_H_
#define APPLICATION_SYSLOG_H_
...
#define LOG(level, fmt, arg...)  \
    UsartPrintf("%s : %s <%s : %u> : " fmt "", level, LOG_TAG, __FUNCTION__, __LINE__, ##arg)
...
#define LOG_ERR(fmt, arg...)	LOG(LOG_LEVEL_ERROR, fmt, ##arg)
#define LOG_WARN(fmt, arg...)	LOG(LOG_LEVEL_WARNING, fmt, ##arg)
#define LOG_INFO(fmt, arg...)	LOG(SYS_LOG_INFO, fmt, ##arg)
