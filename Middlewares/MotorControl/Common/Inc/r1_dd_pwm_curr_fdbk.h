...
typedef struct {
    ...
    uint16_t t_after;            /*!< It is the sum of dead time plus rise time
                                  express in number of TIM clocks.*/
    uint16_t t_before;           /*!< It is the value of sampling time
                                  expressed in numbers of TIM clocks.*/
    uint16_t t_min;              /*!< It is the sum of dead time plus rise time
                                  plus sampling time express in numbers of
                                  TIM clocks.*/
    uint16_t ht_min;             /*!< It is the half of t_min value.*/
    uint16_t t_sample;           /*!< It is the sampling time express in
                                  numbers of TIM clocks.*/
    uint16_t max_tr_ts;          /*!< It is the maximum between twice of rise
                                  time express in number of TIM clocks and
                                  twice of sampling time express in numbers
                                  of TIM clocks.*/
    uint16_t dead_time;          /*!< Dead time in number of TIM clock
    ...
    uint8_t instance_nbr;        /*!< Instance number with reference to PWMC
                                  ...
                                  initializations */
    uint8_t i_channel;           /*!< ADC channel used for conversion of
    ...
    bool is_first_r1dd_instance; /*!< Specifies whether this object is the first
