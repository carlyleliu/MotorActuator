 ...
 */
typedef struct {
    int16_t seg_div;                    /**< Segments divisor */
    int32_t ang_coeff[MTPA_ARRAY_SIZE]; /**< Angular coefficients table */
...
void mtps_calc_curr_ref_from_iq(mtpa_t* phandle, qd_t* iqd_ref);
