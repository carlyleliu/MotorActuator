...
void system_clock_config(void)
{
    ...
    RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_ADC12;
...
static void tim1_init(void)
{
    ...
    htim1.Init.Period = (uint16_t)(SYSTEM_FREQ / PWM_FREQ) / 2;
...
static void tim8_init(void)
{
    ...
    htim8.Init.Period = (uint16_t)(SYSTEM_FREQ / PWM_FREQ) / 2;
...
/**
 * @brief peripherals_init Initialization Function
 * @param None
 * @retval None
 */
