#ifndef __DRIVERS_ICM20602_H__
#define __DRIVERS_ICM20602_H__
...
/* port for diff platform */
#define CS_ICM_Pin       GPIO_PIN_12
#define CS_ICM_GPIO_Port GPIOB
#define ICM20602_ADDRESS 0xD2

#define ICM20602_ENABLE  HAL_GPIO_WritePin(CS_ICM_GPIO_Port, CS_ICM_Pin, GPIO_PIN_RESET);
#define ICM20602_DISABLE HAL_GPIO_WritePin(CS_ICM_GPIO_Port, CS_ICM_Pin, GPIO_PIN_SET);
