...
set(CMAKE_C_FLAGS "${MCU_FLAGS} -std=gnu99 -Wall -fdata-sections -ffunction-sections ${DBG_FLAGS} --specs=nosys.specs" CACHE INTERNAL "C compiler flags")
...
set(CMAKE_CXX_FLAGS "${MCU_FLAGS} -fno-rtti -fno-exceptions -fno-builtin -Wall -fdata-sections -ffunction-sections ${DBG_FLAGS} -Wno-volatile --specs=nosys.specs" CACHE INTERNAL "Cxx compiler flags")
